...
private:
    ...
    void input_dinamic(int**& array, int& row_count) // создание функции по вводу динамического массива с экрана
    {
...
setlocale(LC_ALL, "Russian");
    ...
    //int **array3 ;
    matrix a;
    a.input_dinamic(array, row_count);
